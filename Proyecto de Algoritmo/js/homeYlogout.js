...
//---------------------- ALERTA CUANDO SE REGISTRE UN NUEVO PRODUCTO --------------------//

function productoExistoso(){
  if(!localStorage.getItem('producto') === true){
    swal('Genial', '¡Tu Producto ha sido Registrado con Éxito!', 'success');
    localStorage.setItem('producto', false);
  };
};
productoExistoso();
...
//-------------------------- VOLVER A PAGINA DE INCIO ---------------------------//

function volverInicio(){
  window.open("Pagina-Inicio.html", "_blank");
};
